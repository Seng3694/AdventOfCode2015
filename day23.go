...
func day23_parse_file(fileName string) []Instruction {
...
func day23_run_program(r *Registers, instructions []Instruction) {
	finished := false
	for !finished {
...
func day23() (string, string) {
	instructions := day23_parse_file("input/day23.txt")
	r := Registers{}

	day23_run_program(&r, instructions)
	part1 := r.b
