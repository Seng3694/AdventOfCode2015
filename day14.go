...
func day14_parse_line(line string) ReindeerData {
...
func day14_calc_race_results(data []ReindeerData, seconds int) (maxDistance, maxPoints int) {
...
func day14() (string, string) {
	...
	for scanner.Scan() {
		line := scanner.Text()
		data = append(data, day14_parse_line(line))
	}

	dist, points := day14_calc_race_results(data, 2503)

	return fmt.Sprint(dist), fmt.Sprint(points)
}
