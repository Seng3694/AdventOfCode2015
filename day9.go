...
func day9_parse_line(str string, locationMap map[string]*Location) {
...
func day9_permutations(currentIndex int, smallestDistance *int, longestDistance *int, locations []string, indices []int, locationMap map[string]*Location) {
	...
	for i := 0; i < len(locations); i++ {
		...
		day9_permutations(currentIndex+1, smallestDistance, longestDistance, locations, indices, locationMap)
	}
}
...
func day9() (string, string) {
	...
	for scanner.Scan() {
		line := scanner.Text()
		day9_parse_line(line, locationMap)
	}
	...
	day9_permutations(0, &shortestdistance, &longestDistance, locations, indices, locationMap)

	return fmt.Sprint(shortestdistance), fmt.Sprint(longestDistance)
}
