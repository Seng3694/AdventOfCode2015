...
func day5_is_nice_part1(str string) bool {
	var (
		vowelCount      int
...
func day5_is_nice_part2(str string) bool {
	var (
...
func day5() (string, string) {
	...
	for scanner.Scan() {
		line := scanner.Text()
		if day5_is_nice_part1(line) {
			niceStringCount1++
		}
		if day5_is_nice_part2(line) {
			niceStringCount2++
		}
	}

	return fmt.Sprint(niceStringCount1), fmt.Sprint(niceStringCount2)
}
